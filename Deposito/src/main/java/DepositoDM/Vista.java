    ...
    public int login() {
        ...
        do{
            ...
            try {
                log = Leer.nextInt();
                if (log>5){
                    System.out.println("Numero fuera de rango maximo");
                    System.out.println("Vuelva a intentarlo");
                } else if (log<0) {
                    System.out.println("Numero fuera de rango minimo");
                    System.out.println("Vuelva a intentarlo");
                } else {
                    repetir = false;
                }
        ...
        do{
            ...
            try {
                ...
                if(num<=0) {
                    ...
                    System.out.println("Intente con un numero mas pequeño");
                }else {
                    repetir = false;
                }
